...
The build script we'll be using is contained in the Cashhand github repository ([contrib/gitian-build.py](https://github.com/CashHand-Project/cashhand/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Cashhand repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/CashHand-Project/cashhand/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, cashhand-detached-sigs, and cashhand GitHub repos.
