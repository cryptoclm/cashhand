...
The script [extract-osx-sdk.sh](https://github.com/CashHand-Project/cashhand/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
cashhand/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/CashHand-Project/cashhand/blob/master/doc/README_osx.md) for troubleshooting tips.