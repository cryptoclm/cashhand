...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 CASHHAND
    ...
    MAKE_SPORK_DEF(SPORK_17_COLDSTAKING_ENFORCEMENT,        1598626800), // ON 08/28/2020 @ 3:00pm (UTC)
    MAKE_SPORK_DEF(SPORK_19_DEVFEE,                         4070908800ULL), // OFF
...
// CASHHAND: on startup load spork values from previous session if they exist in the sporkDB
...
void CSporkManager::ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // CASHHAND: add to spork database.
